...
## Author's notes
This code is generated by Cursor agent based on author's written design doc - [task.md](https://github.com/BambooPalace/htx-assignment/blob/main/task.md) . Please view it to understand author s design principles.
